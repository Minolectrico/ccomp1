...
public:
    Motor_vehiculo(std::string _marca, std::string _tipo_combustible, int _año_fabricacion, std::string _color, int _cilindrada):marca(_marca), tipo_combustible(_tipo_combustible),año_fabricacion(_año_fabricacion),color(_color),cilindrada(_cilindrada) {}
